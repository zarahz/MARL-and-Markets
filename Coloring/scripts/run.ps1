...
& .\scripts\powershell\easy\2-ppo-competitive.ps1

& .\scripts\powershell\easy\1-dqn.ps1
& .\scripts\powershell\easy\2-dqn.ps1
& .\scripts\powershell\easy\2-dqn-mixed.ps1
& .\scripts\powershell\easy\2-dqn-competitive.ps1

# -----------------

# HARD
& .\scripts\powershell\hard\top_ppo_stats.ps1
& .\scripts\powershell\hard\top_dqn_stats.ps1

# -----------------

# Rooms
& .\scripts\powershell\hard\top_stats_rooms.ps1
