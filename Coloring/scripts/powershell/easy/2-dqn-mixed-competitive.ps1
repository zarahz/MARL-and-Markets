...
pipenv run python -m Coloring.scripts.train --algo dqn --agents 2 --model easy\\2-dqn-mixed-competitive-sm-goal-no-debt `
    --setting mixed-motive-competitive `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 2 --model easy\\2-dqn-mixed-competitive-sm-no-reset-no-debt `
#     --setting mixed-motive-competitive `
...
pipenv run python -m Coloring.scripts.train --algo dqn --agents 2 --model easy\\2-dqn-mixed-competitive-am-goal-no-debt `
    --setting mixed-motive-competitive `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 2 --model easy\\2-dqn-mixed-competitive-am-no-reset-no-debt `
#     --setting mixed-motive-competitive `
