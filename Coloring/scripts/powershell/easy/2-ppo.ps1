...
# #----------------------------------------------------------------------------------------
pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-sm `
    --market sm `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-sm-goal `
    --market sm-goal `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-sm-no-reset `
    --market sm-no-reset `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-sm-goal-no-reset `
...
#----------------------------------------------------------------------------------------
pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am `
    --market am `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am-goal `
    --market am-goal `
    --trading-fee 0.1
    
pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am-no-reset `
    --market am-no-reset `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am-no-debt `
    --market am-no-debt `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am-goal-no-reset `
    --market am-goal-no-reset `
    --trading-fee 0.1

pipenv run python -m Coloring.scripts.train --algo ppo --model easy\\2-ppo-am-goal-no-debt `
