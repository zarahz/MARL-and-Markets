...
#     --batch-size 64 `
#     --initial-target-update 1000 `
#     --target-update 200000 `
#     --replay-size 700000 `
#     --epsilon-decay 300000 `

# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-8 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 64 `
#     --initial-target-update 1000 `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-9 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 64 `
#     --initial-target-update 1000 `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-10 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 128 `
#     --initial-target-update 1000 `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-13 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 64 `
#     --initial-target-update 1000 `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-14 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 32 `
#     --initial-target-update 1000 `
...
# pipenv run python -m Coloring.scripts.train --algo dqn --agents 1 --model 1-dqn-16 `
#     --max-steps 300 `
#     --capture-interval 20 `
#     --batch-size 64 `
