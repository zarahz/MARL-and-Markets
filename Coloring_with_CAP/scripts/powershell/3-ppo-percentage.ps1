...
pipenv run python -m Coloring_with_CAP.scripts.train --agents 3 --model 3-ppo-percentage-sm-no-reset `
    --setting percentage-reward `
    --market sm-no-reset `
    --max-steps 350 `
    --capture-interval 20
...
pipenv run python -m Coloring_with_CAP.scripts.train --agents 3 --model 3-ppo-percentage-am-no-reset `
    --setting percentage-reward `
    --market am-no-reset `
    --max-steps 350 `
    --capture-interval 20
