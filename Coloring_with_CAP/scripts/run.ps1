...
# & .\Coloring_with_CAP\scripts\powershell\1-ppo.ps1
# & .\Coloring_with_CAP\scripts\powershell\1-dqn.ps1
& .\Coloring_with_CAP\scripts\powershell\3-ppo.ps1
& .\Coloring_with_CAP\scripts\powershell\3-ppo-mixed.ps1
& .\Coloring_with_CAP\scripts\powershell\3-ppo-mixed-competitive.ps1
# & .\Coloring_with_CAP\scripts\powershell\3-ppo-percentage.ps1
# & .\Coloring_with_CAP\scripts\powershell\3-ppo-rooms.ps1
