...
def make_env(env_key, agents, grid_size=5, percentage_reward=False, mixed_motive=False, market="", trading_fee=0.05, seed=None):
    ...
    env = gym.make(id=env_key, agents=agents, size=grid_size,
                   market=market, trading_fee=trading_fee)
