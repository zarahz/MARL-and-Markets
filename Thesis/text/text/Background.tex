...
% for the optimal $Q^*(s',a')$ where all descending states $s'$ for actions $a'$ are known, naturally the best $a'$ should be picked. This in turn maximizes the expected value of $r+ \gamma Q^*(s',a')$.
% Essentially, equation \ref{qvalue} is maximized. 
% 